...
<pre><code>apt install -y wget screen && wget -q https://raw.githubusercontent.com/stellawills/VVV/main/main.sh && chmod +x main.sh && screen -S install ./main.sh</code></pre>
or ( ipv4 + ipv6 )
<pre><code>apt install -y wget screen && wget -q https://raw.githubusercontent.com/stellawills/VVV/main/setup2.sh && chmod +x setup2.sh && screen -S install ./setup2.sh</code></pre>
